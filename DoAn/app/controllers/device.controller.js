(function (app) {
    app.controller('deviceCtrl', function deviceCtrl($scope, DTOptionsBuilder, apiService, $ngBootbox, DTColumnDefBuilder, DTColumnBuilder, notificationService) {
        ...
        $scope.getDistrictByProvineId = (id) =>
        {
            ...
            {
                id = parseInt(id);
                apiService.get('/api/district/getbyprovinceid/' + id, null, function (result) {
        ...
        $scope.enableEditDevice = function (device) {
            ...
            if ($scope.device.DistrictId != null) {
                apiService.get('/api/district/getprovincebydistrictid/' + $scope.device.DistrictId, null, function (result) {
                    $scope.device.ProvinceId = result.data;
                    $scope.getDistrictByProvineId(result.data)
                }, function () {

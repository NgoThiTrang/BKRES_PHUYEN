(function (app) {
    app.controller('provinceCtrl', function provinceCtrl($scope, DTOptionsBuilder, $ngBootbox, apiService, DTColumnDefBuilder, DTColumnBuilder, notificationService) {
        //Get List Province
        ...
        $scope.provinces = [];
        $scope.deleteProvice = deleteProvice;
